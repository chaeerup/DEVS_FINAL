         ...
         <div class="row">
            ...
            <div class="col-sm-8">
               <div class="d-flex mb-2">
                  ...
                  <input type="button" class="follow" id="${profile.member_id }" onclick="follow();" value="팔로우">
                     </c:when>
                     <c:otherwise>
                  <input type="button" class="unfollow" id="${profile.member_id }" onclick="unfollow();" value="언팔로우">
                     </c:otherwise>
                  </c:choose>
                     <input type="button" style="display: none;" id="follow" class="follow" id="${profile.member_id }" onclick="follow();" value="팔로우">
                     <input type="button" style="display: none;" id="unfollow" class="unfollow" id="${profile.member_id }" onclick="unfollow();" value="언팔로우">
